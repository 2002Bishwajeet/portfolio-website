...
<div class="lg:flex lg:flex-wrap mt-24">
  <div class="flex-col flex text-start items-start justify-evenly w-1/2 h-auto pr-44">
      <p class="text-5xl font-bold">Just say hi</p>
      <p class = "text-2xl">I'm always open to discuss your project and talk about new things</p>
      ...
      <div class="grid grid-cols-1 gap-6">
              <label class="block ">
                ...
                <input type="text" class="
                    ...
                    bg-inherit
                    text-milkish-white
                    placeholder-milkish-white
                    placeholder-opacity-80
                    border-0 border-b-2 border-gray-200
                    focus:ring-0 focus:border-milkish-white
              ...
              <label class="block">
                <textarea class="
                  ...
                  placeholder-milkish-white
                    border-0 border-b-2 border-gray-200
                    focus:ring-0 focus:border-milkish-white
                  " rows="4" placeholder="Your project description"></textarea>
              </label>
