...
<div class="grid gap-16 grid-cols-1  lg:grid-cols-2 mt-24">
  ...
  <div class="bg-shady-black w-full h-full">
    <form class="text-start items-end my-20 mx-24 ">
      ...
      <button
        type="button"
        class="text-shady-black bg-milkish-white hover:bg-gray-300 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mt-4 "
        >Submit</button
      >
    </form>
  </div>
